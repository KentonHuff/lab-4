...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        if(!this.getName().equals(otherEq.getName()))
        {
        	return false;
        }
        ...
        double weightDiff = this.getTotalWeight()-otherEq.getTotalWeight();
        ...
        double priceDiff = this.getTotalPrice()-otherEq.getTotalPrice();
        ...
        if(!this.getDescription().equals(otherEq.getDescription()))
        {
        	return false;
        }
